...
<html lang="en">
  ...
  <body class="{if true eq preg_match("/Android|webOS|iPhone|iPod|iPad|BlackBerry|IEMobile|Opera Mini/", $smarty.server.HTTP_USER_AGENT)}nav-md{else}nav-sm{/if}">
	<div class="container body">
    	<div class="main_container">
    		{include file="Layouts/Common/navigation.tpl"}
