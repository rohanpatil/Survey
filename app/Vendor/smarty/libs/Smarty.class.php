...
function smartyAutoload($class)
{
    ...
    include_once SMARTY_PLUGINS_DIR . 'function.success_message.php';
    include_once SMARTY_PLUGINS_DIR . 'function.show_timezone_warning.php';
    include_once SMARTY_PLUGINS_DIR . 'function.unset_error_messages.php';
	include_once SMARTY_PLUGINS_DIR . 'modifier.date_formatter.php';
	include_once SMARTY_PLUGINS_DIR . 'modifier.truncate.php';
	include_once SMARTY_PLUGINS_DIR . 'function.cycle.php';
	include_once SMARTY_PLUGINS_DIR . 'modifier.relative_datetime.php';
	include_once SMARTY_PLUGINS_DIR . 'modifier.escape.php';
	include_once SMARTY_PLUGINS_DIR . 'modifier.replace.php';
	include_once SMARTY_PLUGINS_DIR . 'modifier.phone_format.php';
	include_once SMARTY_PLUGINS_DIR . 'modifier.change_timezone.php';
	include_once SMARTY_PLUGINS_DIR . 'function.math.php';
	include_once SMARTY_PLUGINS_DIR . 'function.show_external_email_warning.php';
}
